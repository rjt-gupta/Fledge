...
public class OtherEditorActivity extends AppCompatActivity implements
        ...
        mGenderSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals("Organic")) {
                        mGender = MenEntry.GENDER_MALE;
                    } else if (selection.equals("Company")) {
    ...
    private void saveKid() {
        ...
        if (descriptionString.equals("Company") || descriptionString.equals("Organic") || descriptionString.equals("Other")) {
            ...
            if (mCurrentKidUri == null) {
                ...
                int rowsAffected = getContentResolver().update(mCurrentKidUri, values, null, null);
            ...
            Toast.makeText(this,"Description can only be \"Top\" , \"Bottom\" or \"Shoe\" ",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mKidHasChanged) {
                    NavUtils.navigateUpFromSameTask(OtherEditorActivity.this);
                    return true;
                }
    ...
    private void deleteKid() {
        if (mCurrentKidUri != null) {
            int rowsDeleted = getContentResolver().delete(mCurrentKidUri, null, null);

            if (rowsDeleted == 0) {
                Toast.makeText(this, "editor_delete_Kid_failed",
                        Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "editor_delete_Kid_successful",
                        Toast.LENGTH_SHORT).show();
            }
        }
