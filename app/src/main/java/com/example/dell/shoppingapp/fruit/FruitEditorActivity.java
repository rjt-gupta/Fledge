...
public class FruitEditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private boolean mWomenHasChanged = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentWomenUri = intent.getData();

        if (mCurrentWomenUri == null) {
            setTitle("Add new Fruit");
            invalidateOptionsMenu();
        } else {
            setTitle("Edit text");
            getLoaderManager().initLoader(EXISTING_WOMEN_LOADER, null, this);
        }
    ...
    private void saveWomen() {
        ...
        if (mCurrentWomenUri == null &&
                ...
                TextUtils.isEmpty(weightString) && mGender == MenEntry.GENDER_UNKNOWN) {
            return;
        }
        ...
        if (descriptionString.equals("Organic") || descriptionString.equals("Company") || descriptionString.equals("Other")) {
            ...
            if (mCurrentWomenUri == null) {
                ...
                int rowsAffected = getContentResolver().update(mCurrentWomenUri, values, null, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mWomenHasChanged) {
                    NavUtils.navigateUpFromSameTask(FruitEditorActivity.this);
                    return true;
                }
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setMessage("Are you sure you want to discrad changes made?");
    ...
    private void deleteWomen() {
        if (mCurrentWomenUri != null) {
            int rowsDeleted = getContentResolver().delete(mCurrentWomenUri, null, null);

            if (rowsDeleted == 0) {
                Toast.makeText(this, "editor_delete_Women_failed",
                        Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "editor_delete_Women_successful",
                        Toast.LENGTH_SHORT).show();
            }
        }
