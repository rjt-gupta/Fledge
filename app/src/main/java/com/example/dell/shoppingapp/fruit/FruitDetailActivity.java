...
public class FruitDetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public void addToCart(View view) {
            ...
            Toast.makeText(FruitDetailActivity.this,"Name "+fname+"id "+c_id+"Product Id "+p_id,Toast.LENGTH_SHORT).show();
            ...
            Intent intent = new Intent(FruitDetailActivity.this, CartDisplayActivity.class);
