...
public class VegetableDetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void addToCart(View view) {
        ...
        Toast.makeText(VegetableDetailActivity.this,"Name "+fname+"id "+c_id+"Product Id "+p_id,Toast.LENGTH_SHORT).show();
        ...
        Intent intent = new Intent(VegetableDetailActivity.this, CartDisplayActivity.class);
